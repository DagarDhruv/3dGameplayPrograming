...
void handleInput(GLFWwindow *window, Game *game)
{
    ...
    {
        // Inside your input handling or update logic
        Matrix3f rotationMatrix = rotateY(5.0f); // Rotate by -5 degrees
    ...
    {
        // Inside your input handling or update logic
        Matrix3f rotationMatrix = rotateX(5.0f); // Rotate by -5 degrees
    ...
    {
        // Inside your input handling or update logic
        Matrix3f ScaleMatrix = ScaleX(99); // Rotate by -5 degrees
    ...
    {
        // Inside your input handling or update logic
        Matrix3f ScaleMatrix = ScaleX(101); // Rotate by -5 degrees
    ...
    {
        // Inside your input handling or update logic
        Matrix3f ScaleMatrix = ScaleY(99); // Rotate by -5 degrees
    ...
    {
        // Inside your input handling or update logic
        Matrix3f ScaleMatrix = ScaleY(101); // Rotate by -5 degrees
    ...
    {
        // Inside your input handling or update logic
        Matrix3f ScaleMatrix = ScaleZ(99); // Rotate by -5 degrees
    ...
    {
        // Inside your input handling or update logic
        Matrix3f ScaleMatrix = ScaleZ(101); // Rotate by -5 degrees
